...
const ew = ['puce', 'taupe', 'avocado', 'baby diarrhea']
...
//ask if it's possible to create a js function that calls a hexcode, returns the color, and applies that color to the text returned - it is!


const instructors = [
    {first: "Zoe", last: "Amese"},
    {first: "Callan", last: "Morrison"},
    {first: "Greg", last: "Korte"},
    {first: "Michael", last: "Clarkeeeee"},
  ];
